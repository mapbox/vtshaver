  ...
  Object.keys(propertyObj).forEach(key => {
    ...
    if (typeof value === 'string') {
      ...
      if (styleSpec.expression.isExpression(value)) {
        // TODO: now we implement this by ourself in vtshavem, we need to talk with style spec team to see if there have a official method to get used property, to make this can be synchronized with the expression update.
