...
var filter_obj = Shaver.styleToFilters({
  "layers": [
    { "id": "landuse", "source-layer": "landuse", filter: true, layout: { "expression-test4": ["==", ["key"], "false"] } },
    { "id": "water", "source-layer": "water", filter: true, layout: { "expression-test4": ["==", ["properties"], "false"] } },
    { "id": "building", "source-layer": "building", filter: true, layout: { "expression-test4": ["==", ["properties"], "false"] } },
    { "id": "road", "source-layer": "road", filter: true, layout: { "expression-test4": ["==", ["properties"], "false"] } },
    { "id": "poi_label", "source-layer": "poi_label", filter: true, layout: { "expression-test4": ["==", ["properties"], "false"] } },
    { "id": "road_label", "source-layer": "road_label", filter: true, layout: { "expression-test4": ["==", ["properties"], "false"] } },
    { "id": "housenum_label", "source-layer": "housenum_label", filter: true, layout: { "expression-test4": ["==", ["properties"], "false"] } }
  ]
});
