...
test('simple style layers', function(t) {
  ...
  }), {water: {filters: ['any',['==','color','blue']], minzoom: 0, maxzoom: 22, properties: []}}, 'returns water:filter for water layer with filter');
  ...
  }), {water:{filters: true, minzoom: 0, maxzoom: 22, properties: []}}, 'returns water:filter for multiple water layers, some with filters');
  ...
  }), {water: {filters: ['any',['!=','color','blue'],['==','color','blue']], minzoom: 8, maxzoom: 16, properties: []}}, 'returns water:filter for multiple water filters, and updates min/max zoom for smallest/largest values');
  ...
  }), {water: {filters: ['any',['!=','color','blue'],['==','color','blue']], minzoom: 0, maxzoom: 22, properties: []}}, 'returns water:filter for multiple water filters, and updates min/max zoom to 0 and 22 if one filter doesn\'t have zooms');
  ...
  }), {water: {filters: ['any',['!=','color','blue'],['==','color','blue']], minzoom: 0, maxzoom: 22, properties: []}}, 'returns water:filter for multiple water layers with filters');
  ...
  }), {water: {filters: ['any',['!=','color','blue']], minzoom: 0, maxzoom: 22, properties: []},landcover: {filters: ['any',['==','color','blue']], minzoom: 0, maxzoom: 22, properties: []}}, 'returns right filters for multiple layers with filters');
